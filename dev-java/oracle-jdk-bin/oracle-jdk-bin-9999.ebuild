...
BASE_URI="http://download.oracle.com/otn-pub/java/jdk/${PV}+10/"

if [[ ${PV} == 12* ]]; then
	JDK_URI+="5295953.html"
	BASE_URI+="e482c34c86bd4bf8b56c0b35558996b9"
else
	JDK_URI+="5066655.html"
	BASE_URI="${BASE_URI/otn-/}"
	BASE_URI+="cf1bbcbf431a474eb9fc550051f4ee78"
fi
