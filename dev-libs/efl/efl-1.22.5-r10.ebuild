...
IUSE="+X avahi +bmp cxx debug doc drm egl elogind fbcon
	+fontconfig fribidi gif +gles2 glib gnutls gstreamer harfbuzz +ico ibus
	jpeg2k libressl neon lua nls opengl ssl pdf physics pixman +png +ppm
